...
function ViewReportPage() {   
  ...
  const { report, staff } = location.state || {}; // get passed data

  const [progressLog, setProgressLog] = useState([
    { id: 1, action: "Report submitted", by: report?.reporter_name, date: report?.created_at },
    { id: 2, action: "Acknowledged by admin", by: "Admin User", date: "2025-09-20 10:15" },
    { id: 3, action: "Assigned to staff", by: "Admin User", date: "2025-09-20 11:00" },
    { id: 4, action: "Work started", by: "Staff A", date: "2025-09-21 09:00" },
    // You can fetch these from DB later
  ]);
