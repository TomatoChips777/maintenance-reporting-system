...
function Notifications() {
  ...
  // fetch notication from the backend
  ...
  // fucntion for filtering notifications
  ...
  // function for searching notifications
  ...
  // triggers show notication modal
  const handleNotificationClick = (notification) => {
    setSelectedNotification(notification);
    setShowModal(true);
  };
  // fuction for marking notifications to read 
      ...
      <Row>
        <Col>
          {loading ? (
            ...
            // This will display if no notifications found.
            ...
            filteredNotifications.map((notification, index) => (
              <Card
                ...
                onClick={() => handleNotificationClick(notification)} // Connected the handleNotification function for showing the details
              >
                <Card.Body className="position-relative">
                  <Card.Title className="fs-6 fw-semibold">
                    {/* Text Truncate is a custom function from folder extra this will limit the text to prevent overlap */}
