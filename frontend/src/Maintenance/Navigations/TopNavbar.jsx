...
function TopNavbar({ toggleSidebar }) {
  ...
  // Fetch notifications with current user id
  ...
  // For dymanic update to the page
  useEffect(() => {
    fetchNotifications();
  ...
  // Return how long the reports is
  ...
  // function for marking notification to read 
    ...
    <>
      <Navbar bg="light" expand="lg" className="sticky-navbar px-3">
        <Container fluid>
          ...
          {/* Left side  for showing or hiding side bar nav*/}
          <div className="d-flex align-items-center">
            <Button variant="outline-secondary" onClick={toggleSidebar} className="me-2">
              ☰
            </Button>
            <Navbar.Brand className="fw-bold">Maintenance</Navbar.Brand>
          </div>
            ...
            <Nav className="ms-auto align-items-lg-center">
              ...
              <Dropdown as={Nav.Item} align="end" className="me-3">
                <Dropdown.Toggle as={Nav.Link} className="position-relative">
                  ...
                  {/* Display count for unread notifications */}
