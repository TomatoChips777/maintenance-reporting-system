...
function ViewReportPage() {
    ...
    if (!report) {
        return <div className="text-center mt-5">No Report Found</div>;
    }

    return (
        <Container fluid className="mt-3">
            <Button variant="secondary" size="sm" className="mb-3" onClick={() => navigate("/reports")}>
                ← Back to Reports
            </Button>
            ...
            <Row>
                {/* Left - Report Info */}
                <Col md={7}>
                    {/* (same as your original left column) */}
                </Col>
                        ...
                        <Card className="shadow-sm">
                            ...
                            <Card.Footer>
                                <Button
                                    ...
                                    disabled={sending || (!subject.trim() || !plainDesc)}
                                >
...
function ViewReportPage() {
    ...
    const [message, setMessage] = useState("");
    const [sending, setSending] = useState(false);
    const [ccReciptience, setCcReciptience] = useState([]);
...
function ViewReportPage() {
    ...
    const handleSendMessage = async () => {
        ...
        try {
            ...
            console.error("Failed to send email. Please try again.:", err);
            setErrorMessage("Failed to send email. Please try again.:", err);
            setShowError(true);
        } finally {
            setSending(false);
